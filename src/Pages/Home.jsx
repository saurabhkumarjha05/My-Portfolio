...
const WORDS = ["Computer Science Undergraduate", "Full-Stack Developer", "ML Research Enthusiast"];
const TECH_STACK = ["React", "Next.js", "Node.js", "Python"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/saurabhkumarjha05" },
  { icon: Linkedin, link: "#" },
  { icon: Instagram, link: "#" },
];
            ...
            >
              <div className="space-y-4 sm:space-y-6">
                ...
                <p
                  ...
                  data-aos-delay="1000"
                >
                  I am a Computer Science undergraduate at COER University with strong interests in Software Engineering, Full-Stack Development, Machine Learning, Explainable AI, and Applied Research.
                </p>
              ...
              <div className="relative w-full opacity-90">
                ...
                >
                  <img
                    ...
                    className={`w-[80%] h-[80%] sm:w-[70%] sm:h-[70%] md:w-[60%] md:h-[60%] object-contain transition-all duration-500 mx-auto ${
                      isHovering
                        ? "scale-105 rotate-2"
                        : "scale-100"
                    }`}
